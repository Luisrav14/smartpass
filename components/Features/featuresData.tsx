...
const featuresData: Feature[] = [
  {
    ...
    title: "Sale of Secure Blockchain Tickets",
    paragraph:
      "",
      // "We specialize in offering secure blockchain-based tickets that ensure authenticity and trust. Our system leverages the power of blockchain technology to generate unique and tamper-proof tickets for events.",
  },
  {
    id: 1,
    icon: (
    ...
    paragraph:
    "",
      // "Our experienced team offers comprehensive event management and planning services to ensure the success of your social events. From small gatherings to large-scale conferences, we handle all aspects of event coordination.",
  },
  {
    id: 1,
    icon: (
