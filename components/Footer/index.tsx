      ...
      >
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            <div className="md:w-12/12 lg:w-12/12 xl:w-12/12 w-full px-12">
              <div className="mb-12 max-w-[100%] text-center lg:mb-16">
                ...
                <p className="mb-9 text-base font-medium leading-relaxed text-body-color">
                  Av. Gral. Lazaro Cardenas 302, Zona Centro, 34000 Durango,
                  Dgo.
                </p>
        ...
        <div className="bg-primary/10 py-8">
          <div className="container">
            <p className="text-center text-base text-body-color dark:text-white">
              Trust, Transparency, and Unforgettable Experiences. SmartPass
              2023.
            </p>
          </div>
        </div>
